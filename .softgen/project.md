...
✅ Public Voting (trust/doubt/distrust) พร้อม IP hash dedup
✅ Cluster Detail pages — 5 กลุ่มยุทธศาสตร์พร้อม stats + policy lists
✅ Global Search — ค้นหานโยบายได้ทุกหน้า
✅ Admin Panel — Authentication, Dashboard, Policy Management
✅ Admin: Updates Review Queue — อนุมัติ/ปฏิเสธ progress updates
✅ Admin: Policy Create/Edit Forms — สร้าง/แก้ไข/ลบนโยบาย
✅ Community Tips — ประชาชนส่งเบาะแส + Admin รีวิว
...
**Typography:**
- Heading: `Noto Sans Thai` (700, 600, 500, 400) — modern, professional, excellent Thai support
- Body: `IBM Plex Sans Thai` (500, 400) — readable, modern, supports Thai numerals
...
7. **Public Vote** — trust/doubt/distrust per policy (IP hash hash)